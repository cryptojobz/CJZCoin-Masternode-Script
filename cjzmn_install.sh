...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cjzcoin.conf'
CONFIGFOLDER='/root/.cjzcoin'
COIN_DAEMON='cjzcoind'
COIN_CLI='cjzcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/cryptojobz/CJZCoin-Masternode-Script/releases/download/v1.0/linux-files-for-masternode.tar.gz'
